...
import com.blaizmiko.adapter.dto.ErrorResponse as Err
import io.ktor.server.plugins.contentnegotiation.ContentNegotiation as ServerContentNegotiation

class DriversEndpointTest : StringSpec({
    ...
    class FakeDataSource(
        ...
        override suspend fun fetchDrivers(season: String): Pair<String, List<Driver>> {
            callCount++
            if (shouldFail) throw RuntimeException("Jolpica unavailable")
    ...
    fun driversTestApp(
        ...
        install(StatusPages) {
            exception<com.blaizmiko.domain.model.ValidationException> { call, cause ->
        ...
        install(Authentication) {
            jwt {
                realm = "test"
                verifier(
                    com.auth0.jwt.JWT.require(com.auth0.jwt.algorithms.Algorithm.HMAC256("test-secret-that-is-at-least-256-bits-long-for-hmac"))
    ...
    fun generateToken(): String {
        return com.auth0.jwt.JWT.create()
            ...
            .sign(com.auth0.jwt.algorithms.Algorithm.HMAC256("test-secret-that-is-at-least-256-bits-long-for-hmac"))
    }
